...
void tTriangle::draw(sf::RenderWindow& window, sf::Color color1)
{
    sf::VertexArray lines(sf::Lines, 6 /*количество точек*/);
    lines[0].position = sf::Vector2f(this->getV1X(), this->getV1Y());
    lines[1].position = sf::Vector2f(this->getV2X(), this->getV2Y());

    lines[2].position = sf::Vector2f(this->getV2X(), this->getV2Y());
    lines[3].position = sf::Vector2f(this->getV3X(), this->getV3Y());

    lines[4].position = sf::Vector2f(this->getV3X(), this->getV3Y());
    lines[5].position = sf::Vector2f(this->getV1X(), this->getV1Y());
