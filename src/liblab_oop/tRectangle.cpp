...
void tRectangle::draw(sf::RenderWindow& window, sf::Color color1)
{
    ...
    lines[3].position = sf::Vector2f(this->getXbr(), this->getYbr());

    lines[4].position = sf::Vector2f(this->getXbr(), this->getYbr());
    lines[5].position = sf::Vector2f(this->getXbl(), this->getYbl());

    lines[6].position = sf::Vector2f(this->getXbl(), this->getYbl());
